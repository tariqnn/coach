  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> list07UserSearchUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final list07UserSearchUsersRecord =
            list07UserSearchUsersRecordList.isNotEmpty
                ? list07UserSearchUsersRecordList.first
                : null;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // this page will show all the usersd in the gym and retrive data to see the progile info of the user
                  Expanded(
                    child: Padding(
                      padding:
