    ...
    return Scaffold(
      ...
      body: Align(
        ...
        child: Container(
          ...
          child:
              // this page will send an email to the id referd to that email when he forgets the passwrod
              Column(
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (_model.idTextController.text.isEmpty) {
                      ...
                      await authManager.resetPassword(
                        email: _model.idTextController.text,
                        context: context,
                      );
                    },
